...
require 'admin/owners_controller'

# Re-raise errors caught by the controller.
class Admin::OwnersController; def rescue_action(e) raise e end; end

class Admin::OwnersControllerTest < Test::Unit::TestCase
  fixtures :admin_owners

  def setup
    @controller = Admin::OwnersController.new
